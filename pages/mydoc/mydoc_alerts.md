...
```
{%raw%}{{site.data.alerts.__TAG__}} 
__________MARKDOWN__CONTENT______________
...
These are the alert tags and their corresponding colour.
...
Within the tag you can freely use __markdown__ to render whatever message you want.
...
This is a tip section and is created using:
{{site.data.alerts.end}}
